...
class conexion{
    ...
    private $usuario ="id18032308_root";
    private $pass = 'Uz!*daTE$eG8PgG';
    private $conexion;

    public function __construct(){
        try{
            $this->conexion = new PDO("mysql:host=$this->servidor;dbname=id18032308_proyecto",$this->usuario,$this->pass);
